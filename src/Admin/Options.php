		...
		add_settings_field(
			...
			function () {
				...
				<select id="retrieval_mode"
					...
					<option value="ADDONS"
						<?php selected( 'ADDONS', isset( $this->sf_shipping_options['retrieval_mode'] ) ? $this->sf_shipping_options['retrieval_mode'] : false ); ?>>
						Addons
					</option>
					<option value="METAS"
						<?php selected( 'METAS', isset( $this->sf_shipping_options['retrieval_mode'] ) ? $this->sf_shipping_options['retrieval_mode'] : false ); ?>>
						Métas
					</option>
				</select>
				<p class="description"
